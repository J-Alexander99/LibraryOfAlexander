...
bp = Piece('b', 'p', 'bronya.jpg')
wp = Piece('w', 'p', 'bronyaH.jpg')
bk = Piece('b', 'k', 'raidenS.jpg')
wk = Piece('w', 'k', 'raidenH.jpg') 
br = Piece('b', 'r', 'himikoS.jpg')
wr = Piece('w', 'r', 'himikoH.jpg')
bb = Piece('b', 'b', 'natashaS.jpg')
wb = Piece('w', 'b', 'natashaH.jpg')
bq = Piece('b', 'q', 'sushangS.jpg')
wq = Piece('w', 'q', 'sushangH.jpg')
bkn = Piece('b', 'kn', 'seeleS.jpg')
wkn = Piece('w', 'kn', 'seeleH.jpg')
